...
if args.model=='RHGN':
    compl_feature = torch.load('{}/pts_feature.npy'.format(args.data_dir))
    lang_feature = torch.load('{}/height_feature.npy'.format(args.data_dir))
    hobbies_feature = torch.load('{}/weight_feature.npy'.format(args.data_dir))
